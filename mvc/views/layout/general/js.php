    <!-- ========== JAVASCRIPT ========== -->
    <script src="<?php echo URL ."mvc/Assets/js/jquery-3.6.0.min.js"?>"></script>    <script src="<?php echo URL ."mvc/Assets/js/bootstrap.min.js"?>"></script>
    ...
    <script src="<?php echo URL ."mvc/Assets/js/all-product.js"?>"></script>
