                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="footer-widget form-mail">
                                ...
                                <div class="bct-payment">
                                    <div class="bct-img">
                                        <img src="<?php echo URL ."mvc/Assets/img/footer/bct.png"?>" alt="">
                                    </div>
                                    <div class="payment-img">
                                        <img src="<?php echo URL ."mvc/Assets/img/footer/payment-1.svg"?>" alt="">
                                        <img src="<?php echo URL ."mvc/Assets/img/footer/payment-2.svg"?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
