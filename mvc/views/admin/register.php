                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?php echo URLAdmin ."/register"?>" method="POST">
                                        ...
                                        <input class="btn btn-danger btn-user btn-block" type="submit" class="fadeIn fourth" value="Register">
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?php echo URLAdmin."login"?>">Already have an account? Login!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
