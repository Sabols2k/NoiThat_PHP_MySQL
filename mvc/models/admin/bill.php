...
class bill extends DB
{
  ...
  public function InsertBill($userid, $totalprice,$address, $createdAt)
  {
    ...
    $sql = "INSERT INTO `bill`(`billid`, `userid`, `totalprice`,`address` ,`createdAt`) VALUES (NULL,'$userid','$totalprice','$address','$createdAt')";
    // echo $sql; die();
  ...
  {
    $sql = "SELECT * from bill where userid ='$id'";
    $this->execute($sql);
